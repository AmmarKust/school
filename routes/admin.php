...
// our team route
Route::get('/ourteams', 'OurTeamController@index')->name('ourteams');
Route::get('/ourteams-data', 'OurTeamController@fetchOurTeamData')->name('ourteam.data.fetch');
Route::get('/add-ourteam', 'OurTeamController@add')->name('ourteam.add');
Route::post('/store-ourteam', 'OurTeamController@store')->name('ourteam.store');
Route::get('/edit-ourteam/{ourteam}', 'OurTeamController@edit')->name('ourteam.edit');
Route::post('/update-ourteam', 'OurTeamController@update')->name('ourteam.update');
Route::get('/delete-ourteam/{ourteam}', 'OurTeamController@destroy')->name('ourteam.delete');
